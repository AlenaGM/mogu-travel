let json = `[{
    ...
    "pricechild": "3000",
    "duration": "3",
    "description": "Район Монмартр, расположенный на одноименном холме, значительно отличается от других кварталов Парижа и своей историей, и атмосферой. В далеком прошлом здесь была небольшая деревня и женский монастырь. Когда Монмартр вошел в состав Парижа, его обитатели остались верны себе и сохранили деревенский уклад жизни. Затем этот живописный уголок французской столицы облюбовали художники, нашедшие здесь всё необходимое: источники вдохновения, недорогое жильё и большое количество ресторанов с дешёвым вином. Запутанные улочки Монмартра хранят память о его прежних обитателях, полны тайн и небольших секретов и располагают к прогулке в маленькой тихой компании. Уделите немного вашего времени этому самому романтичному кварталу Парижа, и он отплатит Вам сполна — незабываемыми впечатлениями и теплыми воспоминаниями!",
    "favorite": "0",
    "capacity": "10",
